package com.tectoy.tectoy_sunmiprinter;
...
/** TectoySunmiprinterPlugin */
public class TectoySunmiprinterPlugin implements FlutterPlugin, MethodChannel.MethodCallHandler {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
    ...
    channel = new MethodChannel(binding.getBinaryMessenger(), "com.tectoy.tectoy_sunmiprinter.TectoySunmiprinterPlugin");
